...
import torch
from models.model import ThreeLayerFullyConnectedNetwork
...
if __name__ == "__main__":
    ...
    # plot_training_progress(train_losses, test_accuracies, output_path='training_plot.png')

    # Plot losses
    plot_losses(num_epochs, train_losses, test_losses, output_path='images/losses.png')

    # Plot accuracies
    plot_accuracies(num_epochs, test_accuracies, output_path='images/accuracies.png')
