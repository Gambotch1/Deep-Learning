...
class CustomMNISTDataset(Dataset):
    def __init__(self, root: str, subset: str, transformation=None):
        ...
        csv_path = os.path.join(root, 'MNIST', f'{subset}.csv')
        self.annotations = pd.read_csv(csv_path)
        
        # Set up the image directory path 
        self.image_dir = os.path.join(root, 'MNIST', subset)
...
project_root = "C:/Users/omari/OneDrive - Technische Universität Ilmenau/SS 2024/Deep Learning/Exercice/dlcv24-assignment-1-Gambotch1/dlcv24-assignment-1-Gambotch1"
